					...
					<tr valign="top">
						...
						<td>
							<select name="gllr_order_by">
								...
								<option value="rand" <?php selected( 'rand', $this->options["order_by"] ); ?>><?php _e( 'Random', 'gallery-plugin' ); ?></option>							
							</select>
				...
				<tr valign="top">
					...
					<td>
						<select name="gllr_album_order_by">
							...
							<option value="rand" <?php selected( 'rand', $this->options["album_order_by"] ); ?>><?php _e( 'Random', 'gallery-plugin' ); ?></option>							
						</select>
					...
					<table class="form-table bws_pro_version">
						...
						<tr valign="top">
							...
							<td>
								...
								<span class="bws_info"><?php _e( 'Select social buttons position in a lightbox.', 'gallery-plugin' ); ?></span>
							</td>
						</tr>
						<tr valign="top">
